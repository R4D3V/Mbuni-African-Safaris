...
export default function Page() {
  const highlights = ["Gorilla trekking permits (limited daily)","One unforgettable hour with a gorilla family","350+ bird species including 23 Albertine Rift endemics","Batwa Pygmy cultural experience","Mountain scenery at 1,160–2,607m elevation"];
  return (
    <>
      <div className="page-hero">
        ...
        <div className="flex items-center gap-5 mb-4">
          ...
          <div>
            <p className="text-[11px] font-bold tracking-[0.22em] uppercase text-gray-400 mb-1">UNESCO World Heritage Site</p>
            <h1 className="font-[family-name:var(--font-bebas)] tracking-wide text-gray-900" style={{ fontSize: "clamp(30px,5vw,60px)" }}>Bwindi Impenetrable Forest</h1>
          </div>
        </div>
        <p className="text-gray-500 max-w-2xl leading-relaxed">Home to over 400 mountain gorillas — half the world's remaining population. The most extraordinary wildlife encounter on Earth.</p>
      </div>
          ...
          <div className="space-y-14">
            ...
            <AnimatedSection>
              <div className="relative w-full overflow-hidden" style={{ height: "420px" }}>
                <Image src="https://images.unsplash.com/photo-1612686635542-2244ed9f8ddc?auto=format&fit=crop&w=1200&q=80" alt="Bwindi Impenetrable Forest" fill className="object-cover" />
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="text-gray-500 leading-relaxed text-lg mb-10">Bwindi Impenetrable Forest National Park is one of Africa's most biodiverse ecosystems. The ancient forest — over 25,000 years old — harbours more than 400 mountain gorillas across 19 habituated families, making it the world's top destination for gorilla trekking.</p>
              ...
              <div className="border border-gray-200 overflow-hidden">
                ...
                <div className="relative p-7">
                  ...
                  <div className="space-y-3">
                    <a href="https://wa.me/256751621506?text=Hi, I'm interested in a safari to Bwindi Impenetrable Forest. Can you help?" target="_blank" rel="noopener noreferrer" className="btn-gold w-full text-center block">💬 WhatsApp Now</a>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div><p className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Best Time</p><p className="text-sm text-gray-600">Jun–Sep, Dec–Feb</p></div>
                    </div>
                    <div className="flex items-center gap-3">
                      <DollarSign className="w-4 h-4 shrink-0" style={{ color: "var(--color-brand)" }}/>
                      <div><p className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Starting From</p><p className="text-sm text-gray-600">$700 permit per person</p></div>
                    </div>
                  </div>
                </div>
              </div>
