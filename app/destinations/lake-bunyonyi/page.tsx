...
export default function Page() {
  const highlights = ["Canoe between 29 stunning islands","Swimming in safe, hippo-free waters","Batwa pygmy cultural village experience","Scenic hillside hiking through terraces","Star gazing from the lake shores"];
  return (
    <>
      <div className="page-hero">
        ...
        <div className="flex items-center gap-5 mb-4">
          ...
          <div>
            <p className="text-[11px] font-bold tracking-[0.22em] uppercase text-gray-400 mb-1">Relaxation</p>
            <h1 className="font-[family-name:var(--font-bebas)] tracking-wide text-gray-900" style={{ fontSize: "clamp(30px,5vw,60px)" }}>Lake Bunyonyi</h1>
          </div>
        </div>
        <p className="text-gray-500 max-w-2xl leading-relaxed">Africa's second deepest lake — 29 stunning islands, crystal-clear waters and terraced hillsides in the Kigezi highlands.</p>
      </div>
          ...
          <div className="space-y-14">
            ...
            <AnimatedSection>
              <div className="relative w-full overflow-hidden" style={{ height: "420px" }}>
                <Image src="https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?auto=format&fit=crop&w=1200&q=80" alt="Lake Bunyonyi" fill className="object-cover" />
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="text-gray-500 leading-relaxed text-lg mb-10">Lake Bunyonyi — 'place of many little birds' — is Uganda's most scenic body of water, dotted with 29 islands. Surrounded by terraced hillsides in the Kigezi highlands near Kabale, the lake offers a peaceful sanctuary for swimming, canoeing and Batwa cultural experiences.</p>
              ...
              <div className="border border-gray-200 overflow-hidden">
                ...
                <div className="relative p-7">
                  ...
                  <div className="space-y-3">
                    <a href="https://wa.me/256751621506?text=Hi, I'm interested in a safari to Lake Bunyonyi. Can you help?" target="_blank" rel="noopener noreferrer" className="btn-gold w-full text-center block">💬 WhatsApp Now</a>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div><p className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Starting From</p><p className="text-sm text-gray-600">From $80/day</p></div>
                    </div>
                  </div>
                </div>
              </div>
