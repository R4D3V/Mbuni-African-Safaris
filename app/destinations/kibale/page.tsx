...
export default function Page() {
  const highlights = ["Chimpanzee tracking with expert guides","12 primate species including red colobus","Bigodi Wetland Sanctuary bird watching","Night walks to spot nocturnal primates","Crater lakes scenic canoe rides"];
  return (
    <>
      <div className="page-hero">
        ...
        <div className="flex items-center gap-5 mb-4">
          ...
          <div>
            <p className="text-[11px] font-bold tracking-[0.22em] uppercase text-gray-400 mb-1">Primate Capital of the World</p>
            <h1 className="font-[family-name:var(--font-bebas)] tracking-wide text-gray-900" style={{ fontSize: "clamp(30px,5vw,60px)" }}>Kibale Forest National Park</h1>
          </div>
        </div>
        <p className="text-gray-500 max-w-2xl leading-relaxed">Home to 1,500 chimpanzees and 12 other primate species. Uganda's premier destination for chimpanzee tracking.</p>
      </div>
          ...
          <div className="space-y-14">
            ...
            <AnimatedSection>
              <div className="relative w-full overflow-hidden" style={{ height: "420px" }}>
                <Image src="https://images.unsplash.com/photo-1516426122078-c23e76319801?auto=format&fit=crop&w=1200&q=80" alt="Kibale Forest National Park" fill className="object-cover" />
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection>
              ...
              <p className="text-gray-500 leading-relaxed text-lg mb-10">Kibale Forest National Park is the primate capital of the world, harbouring 13 primate species including 1,500 chimpanzees. The park's chimpanzee tracking experience is among the most exciting in Africa — follow expert trackers through lush tropical forest to encounter these fascinating creatures.</p>
              ...
              <div className="border border-gray-200 overflow-hidden">
                ...
                <div className="relative p-7">
                  ...
                  <div className="space-y-3">
                    <a href="https://wa.me/256751621506?text=Hi, I'm interested in a safari to Kibale Forest National Park. Can you help?" target="_blank" rel="noopener noreferrer" className="btn-gold w-full text-center block">💬 WhatsApp Now</a>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div><p className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Location</p><p className="text-sm text-gray-600">Western Uganda</p></div>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div><p className="text-[10px] font-bold tracking-widest uppercase text-gray-400">Starting From</p><p className="text-sm text-gray-600">From $90/day</p></div>
                    </div>
                  </div>
                </div>
              </div>
